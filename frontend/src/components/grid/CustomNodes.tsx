...
import { Sun, Wind, Zap, BatteryCharging, Building2, Flame } from "lucide-react";
    ...
    <div className="relative group bg-slate-900/95 backdrop-blur-md border border-orange-500/50 hover:border-orange-400 p-3 rounded-lg shadow-xl shadow-orange-500/10 w-[210px] transition-all">
      ...
      <div className="flex items-center justify-between gap-2 border-b border-orange-500/20 pb-1.5 mb-1.5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[8px] font-mono uppercase tracking-wider text-orange-400">GAS / THERMAL</div>
            <div className="text-[11px] font-bold text-slate-100 truncate max-w-[110px]">{data.label}</div>
          </div>
        </div>
        <span className="px-1 py-0.2 rounded text-[8px] font-mono font-bold bg-orange-950 text-orange-400 border border-orange-800">
          SYNC
        </span>
      </div>
      ...
      <div className="space-y-0.5 text-[10px] font-mono">
        ...
        <div className="flex justify-between text-slate-400">
          <span>HEAT RATE:</span>
          <span className="text-slate-200">7.2 MJ/kWh</span>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative group bg-slate-900/95 backdrop-blur-md border border-rose-500/50 hover:border-rose-400 p-3 rounded-lg shadow-2xl shadow-rose-500/10 w-[210px] transition-all">
      ...
      <div className="flex items-center justify-between gap-2 border-b border-rose-500/20 pb-1.5 mb-1.5">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-[8px] font-mono uppercase tracking-wider text-rose-400">LOAD SINK</div>
            <div className="text-[11px] font-bold text-slate-100 truncate max-w-[110px]">{data.label}</div>
          </div>
        </div>
        <span className="px-1 py-0.2 rounded text-[8px] font-mono font-bold bg-rose-950/80 text-rose-400 border border-rose-800/50">
          DEMAND
        </span>
      </div>
      ...
      <div className="space-y-0.5 text-[10px] font-mono">
        ...
        <div className="flex justify-between text-slate-400">
          <span>PRIORITY:</span>
          <span className="text-emerald-400">TIER-1 SECURE</span>
        </div>
      </div>
    </div>
  );
