      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-4 space-y-4 font-mono text-xs">
          <div className="rounded-xl border border-slate-800 bg-slate-950/90 p-5 shadow-2xl space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-slate-400 text-[11px] block">TARGET CONTINGENCY COMPONENT</label>
              <select
        ...
        <div className="lg:col-span-8 space-y-4 font-mono text-xs">
          ...
          <div
            className={`rounded-xl border p-5 shadow-2xl space-y-4 ${
              isHospitalAtRisk
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center gap-2 text-slate-200 font-bold">
                <HeartPulse
                  className={`w-4 h-4 ${isHospitalAtRisk ? "text-rose-400 animate-pulse" : "text-emerald-400"}`}
                />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center justify-between font-bold">
                  <span className={isHospitalAtRisk ? "text-rose-300" : "text-slate-300"}>
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              ...
              {riskData?.n1_analysis && (
                <span className="text-[10px] text-slate-400">
                  Screened: {riskData.n1_analysis.screened_branches || 50} Elements
                </span>
              )}
            </div>
                  ...
                  >
                    ...
                    <div className="text-right">
                      {comp.utilization_or_loading !== undefined && comp.utilization_or_loading !== null ? (
                        ...
                        <div className="text-amber-400 font-bold">Screened</div>
                      )}
