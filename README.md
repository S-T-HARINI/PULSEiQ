...
- **AI/ML Layer Overview**: [ai/README.md](ai/README.md)
- **Forecasting Module**: [ai/forecasting/README.md](ai/forecasting/README.md)
- **Power Flow & Simulation Engine**: [ai/simulation/README.md](ai/simulation/README.md)
- **Grid Risk & Contingency Engine**: [ai/risk/README.md](ai/risk/README.md)
- **Graph Topology & Network Analytics**: [ai/graph/README.md](ai/graph/README.md)
- **Economic Dispatch & Optimization**: [ai/optimization/README.md](ai/optimization/README.md)
- **Unified Intelligence Pipeline**: [ai/pipeline/README.md](ai/pipeline/README.md)
- **Backend Service & API**: [backend/README.md](backend/README.md)
